...
//        if (TouchEventUtil.getTouchAction(e.getAction()))
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                time = System.currentTimeMillis();
                Log.e(TAG, "消费时间 onInterceptTouchEvent: 按下时间 "+time );
                break;
            case MotionEvent.ACTION_MOVE:

                break;
            case MotionEvent.ACTION_UP:
                Log.d(TAG, "消费时间 == >>>>" +System.currentTimeMillis());
                break;
        }

//        Log.d(TAG, "消费时间 == >>>>" + (System.currentTimeMillis() )+" 事件类型 "+ TouchEventUtil.getTouchAction(e.getAction()));
